...
# with open(train_disease_file, "r") as file:
#     train_data = json.load(file)

# with open(test_disease_file, "r") as file:
...
qa_dataset = QA_Dataset(TOKENIZER, train_df, Q_LEN, T_LEN)
...
# test_question_file = "./test_disease_QA.json"
...
print("here")
# print(qa)
qa.to_csv("disease_augmented_wo_context.csv")
